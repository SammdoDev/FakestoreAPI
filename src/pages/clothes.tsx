...
const Clothes = () => {
  ...
  useEffect(() => {
    fetch("https://api.escuelajs.co/api/v1/products/?categorySlug=clothes")
      .then((res) => res.json())
      ...
      .catch((err) => {
        console.error("Gagal mengambil produk kategori Clothes:", err);
        setLoading(false);
      });
  }, []);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4 text-orange-600">Clothes</h1>
